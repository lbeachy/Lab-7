...
/**A base class for the Rock Paper Scissors Lizard Spock game
 * @author Lance Beachy
 * @version 1.0
 * date 10/12/2019
 */
...
public class RPSLSpock {
    ...
    /**
     *Tests if the human input is a valid selection
     * @param pick the human input
     ...
     * @return ROCK, PAPER, SCISSORS, LIZARD, OR SPOCK based on what the random number generated is
     */
    ...
    /**
     *Tests the computer pick vs the human pick to decide who wins
